...
// SQL query to get all lsaccounts online in the last 5 mins
$stmt = $pdo->prepare('SELECT * FROM lsaccounts WHERE last_seen > date_sub(?, interval 5 minute) ORDER BY full_name');
// Bind params
$stmt->execute([ date('Y-m-d H:i:s') ]);
