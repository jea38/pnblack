...
<body style='margin:0;padding:0' dir='ltr' bgcolor='#ffffff'>
    <table border='0' cellspacing='0' cellpadding='0' align='center' style='border-collapse:collapse'>
      <tbody>
        <tr>
          <td style='font-family:'Poppins', sans-serif;background:#ffffff'>
                    ...
                    <table border='0' width='100%' cellspacing='0' cellpadding='0' style='border-collapse:collapse;text-align:center;width:100%'>
                      <tbody>
                        <tr>
                          ...
                          <td style='line-height:0px;max-width:600px;padding:0'>
                            <table border='0' width='100%' cellspacing='0' cellpadding='0' style='border-collapse:collapse'>
                              <tbody>
                                <tr>
                                  <td style='width:100%;text-align:left;'><img height='50' src='http://192.168.1.132/pnblack/shared/pnbf22.png' style='border:0'></td>
                                </tr>
                              </tbody>
                            </table>
                          </td>
                                                  ...
                                                  <td>
                                                    <table border='0' cellspacing='0' cellpadding='0' style='border-collapse:collapse'>
                                                      <tbody>
                                                        <tr>
                                                          <td>
                                                            <p style='margin:5px 0 10px 0;color:#565a5c;font-size:12px; font-weight: 600;'>Hi User,</p>
                                                            <p style='margin:10px 0 10px 0;color:#565a5c;font-size:12px; font-weight: 600;'>You're attempting to update your password, please use the following One Time Password (OTP): <br><br><span style='font-size: 20px; color:#bf5fff'>$code</span><br><br>
                                                                If this wasn't you, kindly ignore this message.
                                                                Do not share this OTP with anyone. PnBlack takes your account security very seriously. PnBlack Customer Service will never ask you to disclose or verify your PnBlack password or OTP. If you receive a suspicious email with a link to update your account information, do not click on the link—instead, report the email to us for investigation.<br><br> Thank you!
                                                                </p>
                                                          </td>
                                                        </tr>
                                                        <!-- <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style='text-align:center'>
                            ...
                            <div style='color:#abadae;font-size:11px;margin:0 auto 5px auto'>© PnBlack<br></div>
                            <div style='color:#abadae;font-size:11px;margin:0 auto 5px auto'></div>
                          </td>
                          <td width='20' style='display:block;width:20px'>&nbsp;&nbsp;&nbsp;</td>
                          <td width='15px' style='width:15px'></td>
                        </tr>
