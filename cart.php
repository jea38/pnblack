...
<section id="landing-section">
          ...
          <div class="column_2">
            <div></div>
            <div class="column_2b">
              <h1 class="d3">PnBlack <span class='typewriter-text' data-text='[ "Cart 🛒"]'></span>
            </h1>
            </div>
          </div>
        </section>
...
<div class="cart">
    ...
    <form action="" method="post">
                ...
                <tr>
                    <td class="img">
                        ...
                        <a href="<?=url('index.php?page=product&id=' . $product['id'])?>">
                            <img src="<?=base_url?><?=$product['meta']['img']?>" width="50" height="50" alt="<?=$product['meta']['name']?>"  style="vertical-align: middle;" >
                        </a>
                        <?php endif; ?>
                    </td>
                    <td>
        ...
        <div class="buttons">
         <button type="submit" value="Update" name="update" class="button_e btn">
            Update
         </button>
         <button type="submit"  value="Empty Cart" name="emptycart" class="button_e btn">
            Empty Cart
         </button> 
         <button type="submit"  value="Checkout" name="checkout"class="button_e btn">
            Checkout
         </button>
        </div>
