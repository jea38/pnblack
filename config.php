...
define('stripe_ipn_url','https://pnblack.com/ipn/stripe.php');
// Stripe cancel URl, the page the customer returns to when they cancel the payment
define('stripe_cancel_url','https://pnblack.com/cart');
...
define('coinbase_cancel_url','https://pnblack.com/cart');
// Coinbase return URL, the page the customer returns to after the payment has been made
define('coinbase_return_url','https://pnblack.com/placeorder');
?>