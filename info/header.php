...
$url_path = "https://pnblack.com/info/";
?>
...
<head>
    ...
    <!-- Basic Information -->
    <title>PnBlack</title>
    <link rel="icon" type="image/png" href="https://pnblack.com/favicon.png">
    ...
    <!-- Canonical Link -->
    <link rel="canonical" href="https://pnblack.com/">

    <!-- Open Graph / Facebook -->
    <meta property="og:locale" content="en_US">
    <meta property="og:site_name" content="PnBlack">
    <meta property="og:type" content="website">
    <meta property="og:title" content="PnBlack">
    <meta property="og:description" content="Discover a range of products and stay tuned for more.">
    <meta property="og:url" content="https://pnblack.com/">
    <meta property="fb:app_id" content="Your-Facebook-App-ID">
    <meta property="og:image" content="https://pnblack.com/shared/featured-image.jpg">
    <meta property="og:image:secure_url" content="https://pnblack.com/shared/featured-image.jpg">

    <!-- Twitter -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="PnBlack">
    <meta name="twitter:description" content="Discover a range of products and stay tuned for more.">
    <meta name="twitter:image" content="https://pnblack.com/shared/featured-image.jpg">

    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,400i,600,600i,700,700i,900,900i" rel="stylesheet">
    <link rel='stylesheet' href='https://pnblack.com/css/main.css'>
...
<body>
    <header>
                ...
                <div class="fsmenu--text-block">
                    <div class="fsmenu--text-container">
                        <ul class="fsmenu--list">
                            ...
                            <li class="fsmenu--list-element">
                                <a href="https://pnblack.com/products">
                                    <span>Store</span>
                                </a>
                                <div class="fsmenu--scrolling-text">
                            ...
                            <li class="fsmenu--list-element">
                                <a href="https://pnblack.com/info/inu">
                            ...
                            <li class="fsmenu--list-element">
                                <a href="https://pnblack.com/lvs/contact">
      ...
      <li>
          <a href="https://pnblack.com/" id="homelink">
              <div class="svg-space">
      ...
      <li>
          <a href="https://pnblack.com/products" id="productslink">
              <div class="svg-space">
      ...
      <li>
          <a href="https://pnblack.com/myaccount" id="myaccountlink">
    ...
    if (isset($_SESSION['username'])) {
        echo"<a href='".$url_path ."admin.php'> <button class='btn-shiny shiny-effect01'><span>EDITOR</span></button></a>";
        echo"<a href='".$url_path ."new.php'> <button class='btn-shiny shiny-effect01'><span>NEW POST</span></button></a>";
        echo"<a href='".$url_path ."logout.php'> <button class='btn-shiny shiny-effect01'><span>LOGOUT</span></button></a>";
        echo "<link rel='stylesheet' type='text/css' href='https://www.w3schools.com/w3css/4/w3.css'>";
        echo"<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/Trumbowyg/2.19.1/ui/trumbowyg.min.css'>";
    }
    ?>
