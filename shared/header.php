...
<body>
    <header>
                    ...
                    <div class="fsmenu--text-container">
                        <ul class="fsmenu--list">
                            <li class="fsmenu--list-element">
                                <a href="https://pnblack.azurewebsites.net/">
                                    <span>Home</span>
                                </a>
                            ...
                            <li class="fsmenu--list-element">
                                <a href="https://pnblack.azurewebsites.net/products">
                                    <span>Store</span>
                                </a>
                                <div class="fsmenu--scrolling-text">
                            ...
                            <li class="fsmenu--list-element">
                                <a href="https://pnblack.azurewebsites.net/info/inu">
                            ...
                            <li class="fsmenu--list-element">
                                <a href="https://pnblack.azurewebsites.net/lvs/contact">
      ...
      <li>
          <a href="https://pnblack.azurewebsites.net/" id="homelink">
              <div class="svg-space">
      ...
      <li>
          <a href="https://pnblack.azurewebsites.net/products" id="productslink">
              <div class="svg-space">
      ...
      <li>
          <a href="https://pnblack.azurewebsites.net/myaccount" id="myaccountlink">
